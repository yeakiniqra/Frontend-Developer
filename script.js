...
function setLightMode() {
 ...
 gsap.from(".text-container p", {
  ...
  gsap.from("#contact", {
    scrollTrigger: {
      trigger: "#contact", // Start animation when #contact section enters the viewport
      start: "top 80%", // Start animation 80% from the top of the viewport
      end: "bottom top", // End animation when #contact section leaves the viewport
      toggleActions: "play none none reverse", // Play animation on enter, reverse on exit
    },
    opacity: 0,
    y: 50,
  ...
  // Animation for individual contact info containers
  gsap.from(".contact-info-container", {
    scrollTrigger: {
      trigger: ".contact-info-container", // Start animation when .contact-info-container enters the viewport
      start: "top 80%", // Start animation 80% from the top of the viewport
      end: "bottom top", // End animation when .contact-info-container leaves the viewport
      toggleActions: "play none none reverse",
    },
    opacity: 0,
    y: 20,
